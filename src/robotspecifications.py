...
ROBOT_FOOT_HEIGHT = 0.2 # in m
ROBOT_VOLUME_MIN_HEIGHT = 1.2 #in m
ROBOT_VOLUME_MAX_HEIGHT = 1.539 #in m
ROBOT_HEAD_SIZE = 0.2 #in m

ROBOT_DIST_KNEE_FOOT = 0.31
ROBOT_DIST_HIP_KNEE = 0.27
ROBOT_DIST_WAIST_HIP = 0.2;
ROBOT_DIST_NECK_WAIST = 0.5;
ROBOT_DIST_HEAD_NECK = 0.2;

ROBOT_APERTURE_KNEE_FOOT= pi/4;
ROBOT_APERTURE_HIP_FOOT= pi/100;
ROBOT_APERTURE_HIP_KNEE = pi/4;
